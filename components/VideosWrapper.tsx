...
const VideosWrapper = ({ videos }: VideosPropType) => {
  ...
  return videos.map((videoCategory, index) => (
    <div
      key={index}
      className="flex flex-col items-center mt-6 sm:mt-8 md:mt-10 justify-center w-full mb-20"
    >
      <h2 className="text-3xl text-neutral-300 md:text-4xl  lg:text-5xl w-full mb-4 lg:mb-6 text-start  font-feature">
