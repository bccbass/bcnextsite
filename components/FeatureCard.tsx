  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-2">
        <Link
          href={"/" + slug}
          className=" w-full rounded-4xl overflow-hidden shadow-2xl hover:outline-4 outline-primary transition-all duration-300 ease-in-out border border-neutral-400"
        >
