...
const DividerGrunge = ({ topColor = "secondary", bottomColor='background' }: { topColor?: string; bottomColor?: string }) => {
  const fillColor = `var(--color-${topColor})`;
  return (
    ...
    <div className={` h-26 relative`}>
      ...
      <div className={`absolute top-0 w-full h-28 -z-10 bg-${bottomColor}`}></div>
    </div>
  );
};

export default DividerGrunge;
